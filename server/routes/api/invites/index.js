...
const { Account, Invite, User} = require('../../../models');
const uuid = require('uuid').v4;
const { sendInvite } = require('../../../lib/inviteMail');

invitesRouter.param('accountId', loaders('account', 'Account', { enterprise: true }));
invitesRouter.param('inviteId', loaders('invite', 'Invite'));
