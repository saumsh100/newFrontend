...
context('Account Settings - Communications', () => {
  beforeEach(() => {
    cy.login();
  });
  ...
  context('Reminders Settings', () => {
    beforeEach(() => {
      cy.visit('http://localhost:5100/settings/communications/reminders');
    });
  ...
  context('Recalls Settings', () => {
    beforeEach(() => {
      cy.visit('http://localhost:5100/settings/communications/recalls');
    });
