...
describe('Account Settings - Clinic', () => {
  beforeEach(() => {
    cy.login();
  });
  ...
  context('General Settings', () => {
    ...
    it('update clinic contact info', () => {
      cy
        .fillTextInput('contactSettingsForm', 'phoneNumber', '5555555555')
        .fillTextInput('contactSettingsForm', 'contactEmail', 'testclinic@gmail.com')
        .submitForm('contactSettingsForm')
        .reload()
    ...
    it('update administrative info', () => {
      cy
        ...
        .fillTextInput('superAdminSettingsForm', 'timeInterval', 30)
