...
describe('auth lib', () => {
  ...
  describe('#login', () => {
    test('should return a new session and the user model', async () => {
      ...
      expect(omitProperties(model._makeSavableCopy(), ['password'])).toMatchSnapshot();
      expect(omitProperties(session._makeSavableCopy(), ['id'])).toMatchSnapshot();
    });
  ...
  describe('#updateSession', () => {
    test('should remove the session and return a new one', async () => {
      ...
      expect(omitProperties(newSession._makeSavableCopy(), ['id'])).toMatchSnapshot();
    });
  });
