        ...
        <thead>
          <tr>
            <th className={styles.th} style={{ width: '100%' }}>
              ...
              <p className={styles['th-total']}>
                {Object.keys(props.clinics).length}
              </p>
            </th>
            <th className={styles.th}>
              <h2 className={styles['th-title']}>Active Patients</h2>
              <p className={styles['th-total']}>
                {props.totals.totalActivePatients}
              </p>
              <i
                className={`fa fa-users ${styles['th-icon']}`}
                aria-hidden="true"
              />
            </th>
            <th className={styles.th}>
              ...
              <p className={styles['th-total']}>
                {props.totals.totalHygienePatients}
              </p>
              <i
                className={`fa fa-tablet ${styles['th-icon']}`}
                aria-hidden="true"
              />
            </th>
            <th className={styles.th}>
              ...
              <tr className={styles.tr} key={id}>
                <td className={styles.td}>
                  ...
                  <div className={styles['col-content']}>
                    ...
                    <strong className={styles['row-title']}>
                      {clinic.name}
                    </strong>
                  </div>
                </td>
                <td className={styles.td}>
                  ...
                  <div className={styles['col-content']}>
                    <span className={styles['col-numbers']}>
                      <TrendLine
                        width={80}
                        values={clinic.activePatients.month.map(value =>
                          parseInt(value.number, 10))}
                      />
                    </span>
                    <span className={styles['col-numbers']}>
                      {clinic.activePatients.total}
                    </span>
                ...
                <td className={styles.td}>
                  ...
                  <div className={styles['col-content']}>
                    <span className={styles['col-numbers']}>
                      <TrendLine
                        width={80}
                        values={clinic.hygienePatients.month.map(value =>
                          parseInt(value.number, 10))}
                      />
                    </span>
                    <span className={styles['col-numbers']}>
                      {clinic.hygienePatients.total}
                    </span>
                    <span className={styles['col-numbers']}>97%</span>
                  </div>
                </td>
                <td className={styles.td}>
                  ...
                  <div className={styles['col-content']}>
                    <span className={styles['col-numbers']}>
                      <TrendLine
                        width={80}
                        values={clinic.newPatients.month.map(value =>
                          parseInt(value.number, 10))}
                      />
                    </span>
                    <span className={styles['col-numbers']}>
                      {clinic.newPatients.total}
                    </span>
                    <span className={styles['col-numbers']}>97%</span>
                  </div>
                </td>
