  ...
  return (
    <div className={styles.formWrapper}>
      <p className={styles.text}>
        We've sent an email to <span className={styles.email}>{email}</span> with password reset
        instructions.
      </p>
      <p className={styles.text_only_bot_padding}>
        If the email doesn't show up soon, please check your spam folder. We sent the email from{' '}
