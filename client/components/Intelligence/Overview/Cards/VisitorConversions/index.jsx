...
export default function VisitorConversions(props) {
  const { conversionrate, visits, appointments } = props;

  return (
    <Card>
      <CardHeader
        className={styles.cardHeader}
        title="Website Visitor Conversions"
      />
      <div className={styles.websiteVisitorConversions__mainContainer}>
        <div className={styles.websiteVisitorConversions__rowContainer}>
          <div className={styles.websiteVisitorConversions__conversionCount}>
            <span className={styles.websiteVisitorConversions__row1}>
              {conversionrate}%
            </span>
            <span className={styles.websiteVisitorConversions__row2}>
              Conversions Rate
            </span>
          </div>
        </div>
