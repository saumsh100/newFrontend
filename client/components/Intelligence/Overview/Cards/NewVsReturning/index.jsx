...
export default function NewVsReturning(props) {
  const { newVisitors, returningVisitors, chartData } = props;
      ...
      <div className={styles.byGender}>
        <div className={styles.byGender__stats}>
          <div className={styles.byGender__stats__percentage}>
            <span className={styles.byGender__stats__percentage_left}>
              {newVisitors}%
            </span>
            <span className={styles.byGender__stats__percentage_left}>
              New Visitors
          ...
          <div className={styles.byGender__stats__percentage}>
            <span className={styles.byGender__stats__percentage_right}>
              {returningVisitors}%
            </span>
            <span className={styles.byGender__stats__percentage_right}>
              Returning Visitors
