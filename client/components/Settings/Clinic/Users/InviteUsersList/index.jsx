...
class InviteUsersList extends Component {
  ...
  render() {
    const { email, date, onDelete, mainStyle, nameStyle, emailStyle, userListStyle, editStyles, currentUserRole, id } = this.props;
    ...
    return (
      ...
      >
        ...
        <Button onClick={() => this.resendInvite(id)} className={editStyles}>Resend Invitation</Button>
        {button}
      </ListItem>
    );
  }
