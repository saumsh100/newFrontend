...
export const REMOVE_PRACTITIONER = 'REMOVE_PRACTITIONER';
export const SELECT_APPOINMENT_TYPE = 'SELECT_APPOINMENT_TYPE';
...
export const SET_DIALOGS_FILTER = 'SET_DIALOGS_FILTER';
export const READ_MESSAGES_IN_CURRENT_DIALOG = 'READ_MESSAGES_IN_CURRENT_DIALOG';
export const SET_PATIENTS_FILTER = 'SET_PATIENTS_FILTER';
